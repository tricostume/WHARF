...
load models_and_thresholds7d.mat
...
trials_dataTemp = trials_data;
for packing = 1:size(trials_data,1)
    trials_dataTemp{packing,1}(1:7,:) = [trials_data{packing,1}(1:4,:); ...
                                      trials_data{packing,2}(2:4,:)];
end
clearvars trials_data
trials_data = trials_dataTemp;
clearvars trials_dataTemp
